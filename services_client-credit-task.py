...
def draw_alphabet(node, alphabet):
    movements = {
        ...
        'L': [('go', 70,0,0, 50),('go', 0,0,100, 50)],
        'N': [('go', 0,0,100, 50),('go',-70,0,-100, 50),('go',0,0,100, 50)],
        'J': [('move_forward', 60), ('rotate_clockwise', 135), ('move_forward', 100), ('arotate_clockwise', 135), ('move_forward', 80)],
        ...
        'H': [('go', 0, 0, 100, 50),('go', 0, 0, -50, 50),('go', -70, 0, 0, 50),('go', 0, 0, 50, 50),('go', 0, 0, -100, 50)],
	'E': [('go', 0, 0, 100, 50),('go', 0, 0, -50, 50),('go', -70, 0, 0, 50),('go', 0, 0, 50, 50),('go', 0, 0, -100, 50)],
...
def main(args=None):
    ...
    while True:
        print("Menu:")
        print("1. Draw figures in different axis")
        print("2. Land")
